...
import ApplyButton, { isSynchronyApplyLink } from '@shared/apply-button'
        ...
        <div className="grid-container">
          ...
          <div className="footer-link-wrapper">
            <nav aria-label="Footer Links">
              {data?.LinkLists?.map?.(({ LinkList }) => (
                <div className="menu-col" key={LinkList.id}>
                  <div className="heading" role="heading" aria-level="3">
                    {LinkList.HeadingLink.Link.DisplayText
                      ? LinkList.HeadingLink.Link.DisplayText
                      : LinkList.HeadingLink.Link.Title}
                    <i className={activeMenu === LinkList.HeadingLink.Link.Title ? 'menu-active' : 'menu-inactive'} />
                  </div>
                  <div className={`${activeMenu === LinkList.HeadingLink.Link.Title ? 'active' : ''} sub-menu`}>
                    {LinkList.Links.map(({ Link }) => {
                      if (isSynchronyApplyLink(Link?.url)) {
                        return (
                          <ApplyButton
                            key={Link.id}
                            url={Link?.url}
                            ...
                            action="link click"
                          >
                            {Link.DisplayText ? Link.DisplayText : Link.Title}
                          </ApplyButton>
                        )
                      }
                      return (
                        <StrapiLink
                          ...
                          action="link click"
                          target="self"
                          label={Link.DisplayText ? Link.DisplayText : Link.Title}
                          noarialabel="true"
                          trackingData={{
                            category: 'footer',
                            action: 'link click',
                        ...
                        >
                          {Link.Title === 'Link : Request Customer Service ' && (
                            <>
                              {Link.DisplayText}
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: data.Contact.childMarkdownRemark.html,
                }}
              />
            </nav>
          </div>
            ...
            <div className="grid-x">
              <div className="social-icons small-12  large-4">
                <StrapiLink
                  ...
                  className="icon"
                  data={{
                    ExternalUrl: 'https://www.facebook.com/roomstogo/',
                    id: 'facebook-icon',
                  }}
                  trackingData={{
                    category: 'footer',
                ...
                >
                  <img
                    ...
                    src="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2023.94%2051.86%22%20fill%3D%22%230854A0%22%3E%3Cg%20id%3D%22Layer%5f2%22%20data-name%3D%22Layer%202%22%3E%3Cg%20id%3D%22Objects%22%3E%3Cpath%20d%3D%22M5.43%2C51.86H15.87V25.71h7.29L23.94%2C17H15.87V12c0-2.07.42-2.88%2C2.41-2.88h5.66V0H16.71C8.93%2C0%2C5.43%2C3.42%2C5.43%2C10v7H0v8.87H5.43Z%22%2F%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E"
                  />
                </StrapiLink>
                <StrapiLink
                  target="_blank"
                  ...
                  className="icon"
                  data={{
                    ExternalUrl: 'https://twitter.com/RoomsToGo/',
                    id: 'twitter-icon',
                  }}
                  trackingData={{
                    category: 'footer',
                ...
                >
                  <img
                    ...
                    src="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2045.71%2037.15%22%20fill%3D%22%230854A0%22%3E%2Ftitle%3E%3Cg%20id%3D%22Layer%5f2%22%20data-name%3D%22Layer%202%22%3E%3Cg%20id%3D%22Objects%22%3E%3Cpath%20d%3D%22M0%2C32.93a26.56%2C26.56%2C0%2C0%2C0%2C14.38%2C4.22c17.41%2C0%2C27.24-14.71%2C26.65-27.9A19.1%2C19.1%2C0%2C0%2C0%2C45.71%2C4.4a18.7%2C18.7%2C0%2C0%2C1-5.39%2C1.47A9.37%2C9.37%2C0%2C0%2C0%2C44.45.68a18.71%2C18.71%2C0%2C0%2C1-6%2C2.28%2C9.38%2C9.38%2C0%2C0%2C0-16%2C8.55A26.64%2C26.64%2C0%2C0%2C1%2C3.18%2C1.72%2C9.39%2C9.39%2C0%2C0%2C0%2C6.09%2C14.24a9.25%2C9.25%2C0%2C0%2C1-4.25-1.18%2C9.39%2C9.39%2C0%2C0%2C0%2C7.52%2C9.32%2C9.42%2C9.42%2C0%2C0%2C1-4.24.16%2C9.39%2C9.39%2C0%2C0%2C0%2C8.76%2C6.51A18.82%2C18.82%2C0%2C0%2C1%2C0%2C32.93Z%22%2F%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E"
                  />
                </StrapiLink>
                <StrapiLink
                  target="_blank"
                  ...
                  className="icon"
                  data={{
                    ExternalUrl: 'https://www.instagram.com/roomstogo/',
                    id: 'instagram-icon',
                  }}
                  trackingData={{
                    category: 'footer',
                ...
                <StrapiLink
                  ...
                  target="_blank"
                  data={{
                    ExternalUrl: 'https://www.pinterest.com/roomstogo/',
                    id: 'pintrest-icon',
                  }}
                  trackingData={{
                    category: 'footer',
                ...
                <StrapiLink
                  ...
                  className="icon"
                  data={{
                    ExternalUrl: 'https://www.youtube.com/channel/UCd77CqGAnGsyDD-lFFkyrNw',
                    id: 'youtube-icon',
                  }}
                  trackingData={{
                    category: 'footer',
              ...
              <div className="get-app small-12  large-4">
                <StrapiLink
                  className="icon"
                  data={{
                    ExternalUrl: 'https://www.roomstogo.com/app',
                  ...
                  trackingData={{
                    category: 'footer',
                    action: 'click',
                    label: 'RTG app download',
                  }}
                >
                  <img
                    alt="Get the Rooms To Go App"
                    src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 46 86' fill='rgb%28255,255,255%29'%3E%3Cg id='Layer_2' data-name='Layer 2'%3E%3Cg id='Layer_1-2' data-name='Layer 1'%3E%3Cpath d='M6,0A6,6,0,0,0,0,6V80a6,6,0,0,0,6,6H40a6,6,0,0,0,6-6V6a6,6,0,0,0-6-6ZM4,10H42V70H4ZM23,73a5,5,0,1,1-5,5A5,5,0,0,1,23,73Z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E"
                  />
                </StrapiLink>
                <span aria-hidden="true" style={{ display: 'block' }}>
                  Get the Rooms To Go App
                </span>
              </div>
              <div className="payment-methods small-12 large-4">
                <PaymentSvg uniqueNameForId="footer" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="blue-row">
        <div className="grid-container grid-margin-y">
          <div className="rtg-logo grid-x">
            ...
            >
              <div className="footerLogoSvg">
                <RTGLogo uniqueNameForId="footer" fillColor="#fff" />
              </div>
            </StrapiLink>
          </div>
          <div className="notices">
            ...
            <div className="copyright" dangerouslySetInnerHTML={{ __html: data?.Copyright }} />
          </div>
          <div className="logos">
            <img
              src={`${contentfulImage(`${process.env.GATSBY_S3_IMAGE_URL}logo-norton_transparent.png`)}`}
              alt="Norton Secured Powered by digicert"
            />
            <img
              src={`${contentfulImage(`${process.env.GATSBY_S3_IMAGE_URL}logo-bbb_transparent.png`)}`}
